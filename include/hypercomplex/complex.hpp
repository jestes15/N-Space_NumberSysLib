...
{
  // Constants
  constexpr long double __pi = 1.5707963267948966192313216916397514L;
  ...
  public:
    ...
    constexpr complex(_AType& _r = _AType(), _BType& _i = _BType()) : _real(static_cast<value_type>(_r)), _imag(static_cast<value_type>(_i)) {}
    constexpr complex(const complex&) = default;
    template<class type> constexpr complex(const complex<type>& _z) : _real(static_cast<_UnderlyingType>(_z.real())), _imag(static_cast<_UnderlyingType>(_z.imag())) {}

    constexpr _UnderlyingType real() const { return _real; }
    constexpr void real(_UnderlyingType _val) { _real = _val; }
    constexpr _UnderlyingType imag() const { return _imag; }
    constexpr void imag(_UnderlyingType _val) { _imag = _val; }

    constexpr complex& operator= (const _UnderlyingType&);
    constexpr complex& operator+=(const _UnderlyingType&);
    constexpr complex& operator-=(const _UnderlyingType&);
    constexpr complex& operator*=(const _UnderlyingType&);
    constexpr complex& operator/=(const _UnderlyingType&);
    ...
    template<class _Type> constexpr complex& operator= (const complex<_Type>&);
    template<class _Type> constexpr complex& operator+=(const complex<_Type>&);
    template<class _Type> constexpr complex& operator-=(const complex<_Type>&);
    template<class _Type> constexpr complex& operator*=(const complex<_Type>&);
    template<class _Type> constexpr complex& operator/=(const complex<_Type>&);
